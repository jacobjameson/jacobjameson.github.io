...
When you do ridge regression, the code is almost exactly the same as for lasso in R. You just need to change the alpha parameter from 0 to 1. I'll leave this to you as an exercise.
