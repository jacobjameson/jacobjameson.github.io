...
"Machine learning to combat wicked problems: an application to illicit finance".

"Presenting a new atlas of illicit financial flows from trade misinvoicing" (with William Davis and Gamal Ibrahim). [Paper](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3984323){: .btn .btn--document} [Data](https://doi.org/10.5281/zenodo.3610557){: .btn .btn--data} [<i class="fab fa-github"></i> Code](https://github.com/walice/Trade-IFF){: .btn .btn--code}
...
Annex IV of "Track it! Stop it! Get it!" (with Alex Cobham), *Report of the High Level Panel on Illicit Financial Flows from Africa*, Commissioned by the AU/ECA Conference of Ministers of Finance, Planning and Economic Development, 2015. [Paper](https://repository.uneca.org/bitstream/handle/10855/22695/b11524868.pdf?sequence=3&isAllowed=y){: .btn .btn--document} [Media coverage](https://www.theguardian.com/global-development/2015/feb/02/africa-tax-avoidance-money-laundering-illicit-financial-flows){: .btn .btn--media} [<i class="fab fa-github"></i> Code](https://github.com/walice/Africa-illicit-finance){: .btn .btn--code}
...
"Risk Measures for Illicit Financial Flows Dataset" (with Alex Cobham). [Data](https://doi.org/10.5281/zenodo.3371738){: .btn .btn--data} [<i class="fab fa-github"></i> Code](https://github.com/walice/Risk-Analysis-IFF){: .btn .btn--code}

"Illicit Financial Flows from Trade Mis-Invoicing Dataset". [Data](https://doi.org/10.5281/zenodo.3610557){: .btn .btn--data} [<i class="fab fa-github"></i> Code](https://github.com/walice/Trade-IFF){: .btn .btn--code}